...
#	if charAnim.get_animation(charAnim.get_current_animation()) == character.playerCurrentItem.get_animation_reload():
#		return null
#	# ----------------------------------------------------------------------------------------------
#
#
...
#	# --------------------------------------------------------------------------
#	elif charAnim.get_current_animation() == "reload":
#		return null
#	# --------------------------------------------------------------------------
...
func play_state():
	...
	# ----------------------------------------------------------------------------------------------
	if character.playerCurrentItem.get_weapon_state() == character.playerCurrentItem.WeaponState.NOT_FULL:
		
		# If the item has a animation for this State, add it to the animation player and play it
		# ------------------------------------------------------------------------------------------
		var animation_reload = character.playerCurrentItem.get_animation_reload()
		if animation_reload:
			if !charAnim.has_animation(animation_reload.get_name()):
				charAnim.add_animation(animation_reload.get_name(), animation_reload)
				perspAnim.add_animation(animation_reload.get_name(), animation_reload)
			charAnim.play(character.playerCurrentItem.get_animation_reload().get_name())
			perspAnim.play(character.playerCurrentItem.get_animation_reload().get_name())
		# ------------------------------------------------------------------------------------------
